...
def main():
    try:
        ...
        start = MoveGroupPythonInterfaceTutorial()
        ...
        start.go_to_pose_goal()"""

        '''input("============ Press `Enter` to plan and display a Cartesian path ...")
        cartesian_plan, fraction = start.plan_cartesian_path()

        input(
            "============ Press `Enter` to display a saved trajectory (this will replay the Cartesian path)  ..."
        )
        start.display_trajectory(cartesian_plan)

        input("============ Press `Enter` to execute a saved path ...")
        start.execute_plan(cartesian_plan)
        ...
        cartesian_plan, fraction = start.plan_cartesian_path(scale=-1)
